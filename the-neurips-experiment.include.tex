...
\textbackslash begin\{figure\}{[}htb{]}
\textbackslash includegraphics{[}width=0.80\%{]}\{diagrams/neurips/where-do-neurips-papers-go.pdf\}\docx{\includegraphics[width=80\textwidth]{diagrams/neurips/where-do-neurips-papers-go.pdf}}
