...
[This notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Import Meta Reviewer Suggestions.ipynb) does that.
...
import these to your local data base you use [this notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Add Reviewers to Database.ipynb). It also describes how to import suggestions from Area Chairs,
...
information from CMT use [this notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Update DB from CMT Export.ipynb).
...
notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Remind Missing TPMS.ipynb) downloads the output from Laurent's
...
authorship and reviewer are separate. [This notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Find duplicate users.ipynb) tries to find the duplicate users. In 2014, however, there were so
...
notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Duplicate Papers.ipynb) randomly selects 10% of the papers for
...
[This notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Identify Shotgun Submissions.ipynb) tries to identify such
...
bidding stage. [This notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Generate Bidding Lists.ipynb) contains code for
...
allocation with scripts based on similarity scores. [This notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Paper Allocation.ipynb) attempts to allocate papers to area chairs and reviewers.
...
allocated reviewers that they have gained a paper. [This notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Assignment Diffs.ipynb) computes differences in allocation between the initial allocation
...
But did it work? In [this notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Reviewer Expertise.ipynb) we explore the
expertise of the NIPS 2014 reviewing body. We imported the number of papers
associated with each reviewer since 2007 using [this notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Update with NIPS Paper Publications.ipynb).
...
notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Import Review Scores.ipynb).
...
notebook](http://nbviewer.ipython.org/github/lawrennd/nips2014/blob/master/notebooks/Reviewer Calibration.ipynb) we try and correct for individual
