...
and we note in passing that the correlation for this score across the duplicated papers in the NeurIPS experiment was also relatively low:\footnote{Standard error compute as $\sqrt{\frac{1-\rho^2}{n-2}}$} $0.27 \pm 0.075$ (see Appendix \ref{correlation-of-duplicate-papers}).
