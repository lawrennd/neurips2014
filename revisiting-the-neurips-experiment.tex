...
significantly better than a random committee (see Appendix TK in the
supplementary material for an analysis), the reaction from some in the
community was on of surprise (see Appendix TK in the supplementary
...
\section{Review of the Conference and the
...
on the reviewing process and the timelines involved see Appendix TK in
...
\section{Reviewer Calibration and Scoring Inconsistency}\label{reviewer-calibration-and-scoring-inconsistency}}

In this section we look at c
