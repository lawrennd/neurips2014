...
So, the fundamental question would seem to be: how good is the committee at selecting the right papers? Unfortunately we don't have a ground truth assessment of what the right papers are. In the absence of this, in the next section, we explore what happened to accepted papers in terms of their citation impact. 
